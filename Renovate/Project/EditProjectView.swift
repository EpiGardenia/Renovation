...
struct EditProjectView: View {
    ...
    /*
     This should delete the project in our active context, and also dismiss the presentation mode. Remember, dismissing this view will automatically trigger a save anyway, so we don’t need to worry about that here.
     */
    func delete() {
